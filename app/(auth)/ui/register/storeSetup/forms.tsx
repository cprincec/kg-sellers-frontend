                            ...
                            <div className="grid gap-2">
                                ...
                                {/* <Popover open={open} onOpenChange={setOpen}>
                                    <PopoverTrigger asChild>
                                        <Button
                                            variant="outline"
                                            className="justify-between h-12 pr-2 w-full"
                                        >
                                            <div className="flex items-center gap-2 overflow-hidden">
                                                {field.value?.length ? (
                                                    <>
                                                        <div className="hidden lg:flex gap-2 flex-wrap truncate">
                                                            {field.value.map(
                                                                (item: string, index: number) => (
                                                                    <span
                                                                        key={index}
                                                                        className="group flex items-center gap-1 px-2 py-0.5 text-xs bg-kaiglo_grey-100 text-kaiglo_grey-base rounded"
                                                                        onClick={(e) => {
                                                                    ...
                                                                    >
                                                                        {item}
                                                                        <X className="w-3 h-3 group-hover:text-kaiglo_critical-base" />
                                                                    </span>
                                                                )
                                                            )}
                                                        </div>
                                                        <span className="lg:hidden text-sm text-kaiglo_grey-placeholder truncate">
                                                            {field.value.length} selected
                                                        </span>
                                                    </>
                                                ) : (
                                                    <span className="text-sm text-kaiglo_grey-placeholder">
                                                        Select Categories
                                                    </span>
                                                )}
                                            </div>
