...
//     const isLeaf = (node: CategoryNode) => !node.subcategory || node.subcategory.length === 0;
//     const isInPath = (node: CategoryNode) => {
//         // Check if this node is the next expected node in the path
//         if (path.length === 0) return false;
//         const currentPathIndex = path.length - 1;
//         return path[currentPathIndex].category === node.category;
//     };
...
//                             if (val) {
//                                 const productCategoryPath = getValues("productCategoryPath");
//                                 const newPath = getPathFromCategoryPath(productCategoryPath);
//                                 setPath(newPath);
//                             } else {
//                                 setPath([]);
//                             }
...
//                                     {currentLevel.map((option, index) => (
//                                         <Button
//                                             // {console.log(isInPath(option))}
//                                             key={`${option.category}-${index}`}
//                                             className={cn(
//                                                 "justify-start px-2 md:px-6 py-4 font-medium text-base text-kaiglo_grey-800  capitalized md:rounded-none bg-transparent hover:bg-kaiglo_grey-100",
//                                                 isInPath(option) &&
//                                                     "bg-red-500 text-kaiglo_brand-base hover:bg-kaiglo_success-100/80"
//                                                 // value === option.category &&
//                                                 //     "bg-kaiglo_success-50 text-kaiglo_brand-base hover:bg-kaiglo_success-100/80"
//                                             )}
//                                             variant={value !== option.category ? "ghost" : "secondary"}
//                                             onClick={() => {
//                                                 if (isLeaf(option)) {
//                                                     const finalPath = [...path.map((p) => p.category)];
...
//                                                     const newPath = [
//                                                         ...path.map((p) => p.category),
//                                                         option.category,
//                                                     ];
//                                                     setValue("productCategoryPath", newPath);
//                                                 }
//                                             }}
//                                         >
//                                             {console.log(isInPath(option))}
