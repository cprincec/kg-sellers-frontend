...
// import { IProductCategory, IProductCategoryFormValue } from "../../../lib/interface";
// import { categories as c } from "../../../lib/data/productCategories.data";
...
//     const currentLevel = path.length === 0 ? categories : path[path.length - 1].category || [];

//     const isLeaf = (node: CategoryNode) => !node.category || node.category.length === 0;
