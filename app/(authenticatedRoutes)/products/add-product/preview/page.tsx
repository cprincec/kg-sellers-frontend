...
const Preview = () => {
    ...
    if (!productRaw || !productDescription) return <Loader />;
            ...
            <div className="grid gap-6">
                ...
                <section className="grid gap-3 p-4 md:px-6 pb-10 border-b">
                    ...
                    <div className="flex gap-3 flex-wrap items-center">
                        {[productDetails.mainImage, ...productDetails.otherImages].map((image, index) => {
                            ...
                            if (isCollapsed && index + 1 === MAX_PREVIEW_IMAGES + 1) {
                                return (
                                    <div key={index} className="relative">
                                        <Image
                                            key={productRaw.name + " image " + index}
                                            src={image}
                                            alt={productRaw.name + " image"}
                ...
                <FormNavButtons
                    cancelFunc={() =>
                        router.push(`/products/add-product?step=product-variants&product-id=${productRaw.id}`)
                    }
