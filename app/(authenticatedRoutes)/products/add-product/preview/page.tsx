...
const Preview = () => {
    ...
    return <div className="min-h-screen border-l"></div>;
};
...
//                                         +<span>{productDetails.images.length - MAX_PREVIEW_IMAGES}</span>
//                                     </p>
//                                 </div>
//                             </div>
//                         );
...
//                 <ProductVariantsTable productVariants={variants} showTitle={false} showActions={false} />
//             ) : (
