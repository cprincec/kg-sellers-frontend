...
const GotSomethingToSell = () => {
    return (
        <div className="px-5 py-10 ">
            <div className="flex items-center justify-center min-h-[300px] md:min-h-[356px] bg-center bg-cover bg-home-GSTS-mobile md:bg-home-GSTS-desktop rounded-2xl md:rounded-[32px]">
